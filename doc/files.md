...
* epr.conf: contains configuration settings for eprd or epr-qt
* eprd.pid: stores the process id of eprd while running
...
* debug.log: contains debug information and general logging generated by eprd or epr-qt
