Bitcoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/epr/files/Bitcoin/epr-0.8.4/
...
code, causing the Bitcoin-Qt or eprd process to crash.
Bloom filters were introduced with version 0.8, so versions 0.8.0
through 0.8.3 are vulnerable to this critical denial-of-service attack.

A constant-time algorithm is now used to check RPC password
guess attempts; fixes https://github.com/epr/epr/issues/2838
(CVE-2013-4165)
...
Linux: clicking on epr: links was broken if you were using
