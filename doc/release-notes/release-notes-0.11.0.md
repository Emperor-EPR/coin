Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://epr.org/bin/epr-core-0.11.0/>
...
For example, add the following to `epr.conf`:
...
related to the blockchain in the epr system: the raw blocks as received over 
...
For an example script see [epr-submittx](https://github.com/laanwj/epr-submittx).
...
- #5334 `cf87536` libeprconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new epr-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add epr logo to about screen
...
- #5809 `46bfbe7` Add epr-cli man page
...
- #5849 `41259ca` contrib/init/eprd.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for epr-tx)
