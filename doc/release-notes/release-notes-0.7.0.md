Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/epr/files/Bitcoin/epr-0.7.0/

We recommend that everybody running prior versions of eprd/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/epr/epr/tarball/v0.7.0  # .tar.gz
  https://github.com/epr/epr/zipball/v0.7.0  # .zip
...
Core epr handling and blockchain database
...
* Ensure a changed epr unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for epr-qt.exe
* (Windows only): add meta-data to epr-qt.exe (e.g. description)
...
* Bash programmable completion for eprd(1)
