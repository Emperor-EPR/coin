...
//
// Bootup the Masternode, look for a 10000 EPR input and register on the network
//
...
std::string CActiveMasternode::GetStatus()
{
    ...
    case ACTIVE_KARMANODE_INPUT_TOO_NEW:
        return strprintf("Masternode input must have at least %d confirmations", KARMANODE_MIN_CONFIRMATIONS);
