...
static const int64_t PRIVATESEND_COLLATERAL = (10 * COIN);
static const int64_t PRIVATESEND_POOL_MAX = (99999.99 * COIN);
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 EPR - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of epr.
