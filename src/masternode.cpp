...
{
    switch (nActiveState) {
    case CMasternode::KARMANODE_PRE_ENABLED:
        return "PRE_ENABLED";
    case CMasternode::KARMANODE_ENABLED:
        return "ENABLED";
    case CMasternode::KARMANODE_EXPIRED:
        return "EXPIRED";
    case CMasternode::KARMANODE_OUTPOINT_SPENT:
        return "OUTPOINT_SPENT";
    case CMasternode::KARMANODE_REMOVE:
        return "REMOVE";
    case CMasternode::KARMANODE_WATCHDOG_EXPIRED:
        return "WATCHDOG_EXPIRED";
    case CMasternode::KARMANODE_POSE_BAN:
        return "POSE_BAN";
    default:
        return "UNKNOWN";
    }
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    if (mi != mapBlockIndex.end() && (*mi).second) {
        CBlockIndex* pMNIndex = (*mi).second;                                                        // block for 1000 EPR tx -> 1 confirmation
