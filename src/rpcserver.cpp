...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* epr features */
        {"epr", "masternode", &masternode, true, true, false},
        {"epr", "listmasternodes", &listmasternodes, true, true, false},
        {"epr", "getmasternodecount", &getmasternodecount, true, true, false},
        {"epr", "masternodeconnect", &masternodeconnect, true, true, false},
        {"epr", "masternodecurrent", &masternodecurrent, true, true, false},
        {"epr", "masternodedebug", &masternodedebug, true, true, false},
        {"epr", "startmasternode", &startmasternode, true, true, false},
        {"epr", "createmasternodekey", &createmasternodekey, true, true, false},
        {"epr", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"epr", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"epr", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"epr", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"epr", "getmasternodescores", &getmasternodescores, true, true, false},
        {"epr", "mnbudget", &mnbudget, true, true, false},
        {"epr", "preparebudget", &preparebudget, true, true, false},
        {"epr", "submitbudget", &submitbudget, true, true, false},
        {"epr", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"epr", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"epr", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"epr", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"epr", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"epr", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"epr", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"epr", "checkbudgets", &checkbudgets, true, true, false},
        {"epr", "mnsync", &mnsync, true, true, false},
        {"epr", "spork", &spork, true, true, false},
        {"epr", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"epr", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use eprd, or the -server option to epr-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> epr-cli " + methodname + " " + args + "\n";
}
