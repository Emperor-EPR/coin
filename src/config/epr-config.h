/* src/config/epr-config.h.  Generated from epr-config.h.in by configure.  */
/* src/config/epr-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.epr.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "EPR Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "EPR Core 2.3.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "epr"
