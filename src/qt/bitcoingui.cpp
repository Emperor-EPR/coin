                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("EPR Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EPR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and epr: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About EPR Core"), this);
    aboutAction->setStatusTip(tr("Show information about EPR Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EPR"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EPR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EPR addresses"));
    ...
    openAction->setStatusTip(tr("Open a EPR: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EPR Core help message to get a list with possible EPR command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("EPR Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EPR network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    if (masternodeSync.IsBlockchainSynced()) {
        ...
        if (masternodeSync.IsSynced()) {
            ...
            nAttempt = masternodeSync.RequestedMasternodeAttempt < KARMANODE_SYNC_THRESHOLD ?
                           masternodeSync.RequestedMasternodeAttempt + 1 :
                           KARMANODE_SYNC_THRESHOLD;
            progress = nAttempt + (masternodeSync.RequestedMasternodeAssets - 1) * KARMANODE_SYNC_THRESHOLD;
            progressBar->setMaximum(4 * KARMANODE_SYNC_THRESHOLD);
...
{
    QString strTitle = tr("EPR Core"); // default title
