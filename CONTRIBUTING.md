Contributing to EPR Core
============================

The EPR Core project operates an open contributor model where anyone is
...
The following applies to code changes to the EPR Core project, and is not to be
confused with overall EPR Network Protocol consensus changes.

Whether a pull request is merged into EPR Core rests with the project merge
...
Patches that change EPR consensus rules are considerably more involved than
...
Where a patch set proposes to change the EPR consensus, it must have been
...
The project leader is the release manager for each EPR Core release.
